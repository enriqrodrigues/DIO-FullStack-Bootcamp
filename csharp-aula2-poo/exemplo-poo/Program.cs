...
namespace exemplo_poo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var soma = calc.Somar(8, 2);
            var sub = calc.Subtrair(8, 2);
            var mult = calc.Multiplicar(8, 2);
            var div = calc.Dividir(8, 2);

            System.Console.WriteLine(
                "Somar: " + soma + ". Subtrair: " + sub + ". Multiplicar: " + mult + ". Dividir: " + div + "."
            );
